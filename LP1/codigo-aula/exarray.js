...
//Todas as pessoas do bonde que tenham pets
//const bondePets = (bonde.filter((pessoa) => pessoa.pets.length > 0));
//console.log(bondePets);

//Todas as pessoas que não são vegetarianas do
/*const isNotVegetarian = bonde.filter((pessoa)=>pessoa.vegetariana === !true);
console.log(isNotVegetarian);

const isVegetarian = bonde.filter((pessoa)=>pessoa.vegetariana === true);
console.log(isVegetarian);*/

//Todas as pesoas que tenham mais de 50 reais na conta 
/*const moreThan50 = bonde.filter((pessoa)=> pessoa.saldoNaConta> 50);
console.log(moreThan50);*/

//Mostre o nome e a idade de cada pessoa do array
//bonde.forEach((pessoa, index) => console.log(`A pessoa no index ${index} se chama ${pessoa.apelido} e tem ${pessoa.idade} anos `));

//Um array com todas as pessoas que tem Friends como série preferida
const bondeFriends = bonde.forEach((pessoas) => {
  pessoas.seriesPreferiadas.map((e) => console.log(e));
});
  ...
  const numerosDuplicados = numeros.map((e))
